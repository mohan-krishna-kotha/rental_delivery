...
function openGoogleMaps() {
    // Pickup coordinates (example)
    const pickupLat = 12.9716;
    const pickupLng = 77.5946;

    // Delivery coordinates (example)
    const deliveryLat = 12.9784;
    const deliveryLng = 77.6408;

    // Open Google Maps with directions
    const mapsUrl = `https://www.google.com/maps/dir/?api=1&origin=${pickupLat},${pickupLng}&destination=${deliveryLat},${deliveryLng}&travelmode=driving`;
